  ...
  return (
    <div className="flex h-screen bg-[#0b0f1a] text-white overflow-hidden">
      ...
      <aside className="w-64 bg-[#0e1425]/80 backdrop-blur-xl border-r border-white/[0.06] hidden md:flex flex-col">
        ...
        <div className="p-3 border-t border-white/[0.06]">
          <div className="flex items-center gap-2.5 px-3 py-2 rounded-lg hover:bg-white/[0.04] transition-colors cursor-pointer">
            <div className="w-7 h-7 rounded-full bg-gradient-to-br from-emerald-400 to-cyan-500 flex items-center justify-center text-[11px] font-bold">
              U
            </div>
      ...
      <main className="flex flex-col flex-1 min-w-0">
        {/* Top bar (mobile) */}
        <div className="md:hidden flex items-center gap-2.5 px-4 py-3 border-b border-white/[0.06] bg-[#0e1425]/60 backdrop-blur-xl">
          ...
          <div className="max-w-2xl mx-auto space-y-5">
            {messages.map((msg, index) => (
              ...
              >
                ...
                {/* Message bubble */}
                <div
                  className={`px-4 py-2.5 rounded-2xl text-[14px] leading-relaxed max-w-[75%] ${msg.role === "user"
